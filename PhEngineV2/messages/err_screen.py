...
from PhEngineV2.data.config import APPLICATION_PATH, APPLICATION_ICO_path, APPLICATION_ICO_name
from PhEngineV2.space.entities import Button
...
def showTraceback(err, *, flags=pygame.NOFRAME) -> bool:
    ...
    # background surface
    background = pygame.image.load(rf'{APPLICATION_PATH}/PhEngineV2/data/debug_err.png')
    background_size = .9
    ...
    pygame.display.set_icon(
        pygame.image.load(rf'{APPLICATION_PATH}/{APPLICATION_ICO_path}/{APPLICATION_ICO_name}')
    )
...
def showWindow(err, *, caption='Error Message', custom_surf=None, flags=pygame.NOFRAME) -> bool:
    ...
    clock = pygame.time.Clock()
    # process background
    background = pygame.image.load(rf'{APPLICATION_PATH}/PhEngineV2/data/err_background.png')
    ...
    pygame.display.set_icon(pygame.image.load(rf'{APPLICATION_PATH}/{APPLICATION_ICO_path}/{APPLICATION_ICO_name}'))
    # caption
